...
export function FeedNotificationDialog({ feed, onClose }: FeedNotificationDialogProps) {
  ...
  return (
    <Dialog open onOpenChange={(open) => { if (!open) onClose() }}>
      <DialogContent className="max-w-md max-h-[calc(100dvh-2rem)] overflow-hidden p-0" aria-describedby={undefined}>
        ...
        <div className="flex max-h-full min-h-0 flex-col">
          ...
          <div
            data-testid="feed-notification-scroll-area"
            className="min-h-0 flex-1 overflow-y-auto px-6 pb-4 pt-4 pr-4"
          >
