...
const dict = {
  ...
  'chat.scope.countClipped': { ja: '${scoped} / ${total} 件', en: '${scoped} / ${total}' },
  'chat.scope.countSingle': { ja: '${count} 件', en: '${count}' },
...
const zhOverrides: Partial<Record<MessageKey, string>> = {
  ...
  'chat.scope.countClipped': '${scoped} / ${total}',
  'chat.scope.countSingle': '${count}',
