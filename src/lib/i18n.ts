...
const dict = {
  ...
  'notifications.previewBodyTitleOnly': { ja: 'タイトル: ${feedName} · 最大 ${count} 条\n各記事: 原文リンク / 分単位の時刻', en: 'Title: ${feedName} · up to ${count}\nEach article: source link / minute-level time' },
  'notifications.previewBodyTitleAndBody': { ja: 'タイトル: ${feedName} · 最大 ${count} 条\n各記事: 原文リンク / 分単位の時刻 / 正文原文 1 行 / 中文译文 1 行（仅在需要翻译时）/ 最大 3 枚の画像', en: 'Title: ${feedName} · up to ${count}\nEach article: source link / minute-level time / original body line / Chinese translation line when needed / up to 3 images' },
...
const zhOverrides: Partial<Record<MessageKey, string>> = {
  ...
  'notifications.previewBodyTitleOnly': '标题：${feedName} · 最多 ${count} 条\n每篇文章包含：原文链接 / 精确到分钟的时间',
  'notifications.previewBodyTitleAndBody': '标题：${feedName} · 最多 ${count} 条\n每篇文章包含：原文链接 / 精确到分钟的时间 / 正文原文 1 行 / 中文译文 1 行（仅在需要翻译时）/ 最多 3 张图片',
